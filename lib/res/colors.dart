...
class Colours {
  ...
  static const Color text = Color(0xFF262932); //默认黑色
  static const Color dark_text = Color(0xFFffffff); //白色
  ...
  static const Color bg_gray = Color(0xFFFAFAFC);
  ...
  static const Color positiveColor = const Color(0xFFef4726);
